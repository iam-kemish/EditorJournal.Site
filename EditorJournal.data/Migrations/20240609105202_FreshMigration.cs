    ...
    public partial class FreshMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "AuthorName", "Description", "Genre", "ImageUrl", "Price", "Title" },
                values: new object[] { 1, "Author 1", "Description for Item 1", "Thriller", "hhtps//:Image1234", 40.0, "Item 1" });

            migrationBuilder.InsertData(
                table: "companies",
                columns: new[] { "Id", "City", "Name", "PhoneNumber", "PostalCode", "State", "StreetAddress" },
                values: new object[] { 1, "Jempel", "BNT", "097798764534", "047", "jamal", "Server349" });
